...
pub fn render_all(ctx: &TemplateContext) -> BTreeMap<String, String> {
    ...
    let templates: Vec<(&str, &str)> = vec![
        ...
        (
            ...
            include_str!("files/layer_input_mod_rs.txt"),
        ),
        (
            "src/layer/input/discord_input.rs",
            include_str!("files/layer_input_discord_rs.txt"),
        ),
        (
        ...
        (
            ...
            include_str!("files/layer_hidden_mod_rs.txt"),
        ),
        (
            "src/layer/hidden/claude_code_layer.rs",
            include_str!("files/layer_hidden_claude_code_rs.txt"),
        ),
        (
            "src/layer/output/mod.rs",
            include_str!("files/layer_output_mod_rs.txt"),
        ),
        (
